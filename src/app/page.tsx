...
const CARD = "rounded-xl border border-white/10 bg-white/5 p-6 transition-colors hover:border-white/20 hover:bg-white/[0.07]";
  ...
  return (
    <div className="bg-navy-900 text-steel-200">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -right-40 -top-48 h-[620px] w-[620px] rounded-full bg-cleared-500/20 blur-[130px]"
        />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-steel-200/85 sm:text-xl">
                ...
                evidence, your prime questionnaires &mdash; every quarter, for one fixed price.{" "}
                <span className="font-semibold text-white">We hold the proof. You keep your CUI.</span>
              </p>
            ...
            <div className="animate-drift lg:pl-4">
              <HeroConsole />
            </div>
          </div>
        </Container>
          ...
          <Reveal>
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-relaxed text-steel-200/80">
                Under DFARS 7012/7019/7020, every subcontractor that touches CUI has to keep a
                current SPRS score, a live SSP and POA&amp;M, and answer its primes&rsquo; security
                questionnaires. Miss it and the POs stop. Then, from{" "}
                <strong className="text-white">Nov 10, 2026</strong>, CMMC Level 2 certification
                starts gating new contracts.
              </p>
            </div>
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {[
                ...
                <div key={t} className={CARD}>
                  <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-md bg-amber-500/15 text-amber-400">
        ...
        <Container className="py-16 sm:py-24">
          <Reveal>
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-3">
              {STEPS.map((s) => (
                <div key={s.n}>
                  <div className="flex h-11 w-11 items-center justify-center rounded-full bg-cleared-600 text-lg font-bold text-white shadow-sm shadow-cleared-700/30">
                    {s.n}
                  </div>
            ...
            <div className="mt-12 grid gap-5 lg:grid-cols-3">
              <div className={CARD}>
                ...
                <p className="mt-4 text-sm leading-relaxed text-steel-200/80">
                  They hand you a dashboard and leave the work to you. A 30-person shop with one MSP
                  will never operate it.
                </p>
              </div>
              <div className={CARD}>
                ...
                <p className="mt-4 text-sm leading-relaxed text-steel-200/80">
                  They take over your whole environment and your CUI &mdash; heavier, pricier, and a
                  big commitment to unwind.
                </p>
              </div>
              <div className="rounded-xl border-2 border-cleared-500 bg-cleared-500/10 p-6">
                ...
                <p className="mt-4 text-sm leading-relaxed text-white/90">
                  We do the work for you and hold only the compliance proof. Your data and your
                  environment stay yours &mdash; at one fixed price.
                </p>
              </div>
            </div>
            <div className="mt-8">
            ...
            <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
              <div>
                ...
                <p className="mt-5 text-steel-200/80">
                  Software does the repeatable work; a credentialed practitioner signs off on
                  everything that touches your score; a founder runs the relationship.
                </p>
              </div>
              <ul className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <li
                    key={t}
                    className="flex items-start gap-3 rounded-lg border border-white/10 bg-white/5 p-4 text-sm text-steel-200/80 transition-colors hover:border-white/20 hover:bg-white/[0.07]"
                  >
                    <Check /> <span>{t}</span>
                  </li>
                ))}
          ...
          <Reveal>
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-3 max-w-xl text-steel-200/80">
                  About 3–5× the cost of do-it-yourself software &mdash; because we operate it, you
                  don&rsquo;t. One-time onboarding, then a monthly subscription.
                </p>
              </div>
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {TIERS.map((t) => (
                <div
                  key={t.name}
                  className={`rounded-2xl border p-7 transition-colors ${t.featured ? "border-cleared-500 bg-cleared-500/10" : "border-white/10 bg-white/5 hover:border-white/20 hover:bg-white/[0.07]"}`}
                >
              ...
              <div className="mt-6 grid gap-8 md:grid-cols-3">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-steel-200/80">
                    A Registered Practitioner / CMMC-certified professional reviews every
                    SPRS-affecting deliverable before it is posted or sent.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-white">A senior DoD advisor</h3>
                  <p className="mt-2 text-sm leading-relaxed text-steel-200/80">
                    Guides our program and methodology, and stands behind the quality of the work in
                    front of your primes.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-white">We prepare; you attest</h3>
                  <p className="mt-2 text-sm leading-relaxed text-steel-200/80">
                    We are not a C3PAO and never sign your government attestations. You stay in
                    control &mdash; which is exactly the point.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-navy-900 px-8 py-14 text-center sm:px-16">
              ...
              <p className="relative mx-auto mt-4 max-w-xl text-steel-200/80">
                No sales call required to get your report. See exactly where you stand against all
                110 controls &mdash; then decide if you want us to handle it.
              </p>
